...
public class PercolationStats {
	...
	public static void main(String[] args) {
		...
		/**
		 * double time1 = 0, time2 = 0, cost = 0; Stopwatch timer = new Stopwatch();
		 *
		 *
		 ...
		 *
		 * time1 = time2; time2 = timer.elapsedTime(); cost = time2 - time1;
		 *
		 * System.out.printf("size: %-5d| cost: %.3f \n", i, cost); }
		 *
		 * n = 100; timer = new Stopwatch(); time1 = 0; time2 = 0; cost = 0;
		 *
		 * for (int i = n; i <= 1600; i *= 2) {
		 *
		 * PercolationStats test = new PercolationStats(i, t);
